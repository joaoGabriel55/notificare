...
## Goal
Admin-flavored status page at `/job_progress` per ERD §4.

## Scope
- Controllers under `ActiveJob::Progress::Engine`:
...
## Acceptance criteria
- Mounting the engine and visiting `/job_progress` renders the index.
