...
## Goal
ERD §8: `rails generate active_job:notificare:scaffold ImportJob` produces editable starter UI for embedded product pages.

## Scope
- `lib/generators/active_job/notificare/scaffold/scaffold_generator.rb`.
- Inputs: a job class name. Generator validates that the class includes `ActiveJob::Notificare`.
